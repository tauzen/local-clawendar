...
export function createEvent(obj) {
  ...
  if (obj.calendarId !== undefined) {
    event.calendarId = obj.calendarId.trim();
  }
  if (obj.categories !== undefined) {
    event.categories = normalizeCategories(obj.categories);
  }
...
export function validateEvent(obj) {
  ...
  if (obj.calendarId !== undefined) {
    if (typeof obj.calendarId !== "string" || obj.calendarId.trim() === "") {
      errors.push("calendarId must be a non-empty string");
    } else if (obj.calendarId.trim().toLowerCase() === "default") {
      errors.push('calendarId "default" is reserved');
    }
  }
  ...
  if (obj.categories !== undefined) {
    if (!Array.isArray(obj.categories)) {
      ...
      const invalid = obj.categories.some((c) => typeof c !== "string" || c.trim() === "");
      if (invalid) {
        errors.push("categories entries must be non-empty strings");
      }
    }
  }
